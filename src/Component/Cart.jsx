...
const Cart = () => {
    const { totalItems, totalPrice, cart, discountedPrice } = useCart().cartState;
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <div className='shadow-lg'>
                        <div className='m-3'>
                            ...
                            <p className='p-2'>Discounted Price : {Math.round(discountedPrice)}</p>
                            <hr />
                            <p className='p-2 font-semibold'>Total Price : {totalPrice - Math.round(discountedPrice)}</p>
